 ...
 *  
 *  
 * 作者：[冯梓易]   时间：2014/1/22 星期三 上午 10:57:34
 * 文件名：ChineseDate
 * 版本：V1.0.0
 * 
 * 修改者：           时间：               
...
namespace DataCollection.Util
{
    ...
    class ChineseDate
    {
        ...
        public ChineseDate(DateTime dt)
        {
            ...
            leap = 0;
            temp = 0;
            TimeSpan ts = _date - ChineseDate.MinDay;//计算两天的基本差距
            offset = ts.Days;
        ...
        public ChineseDate(int cy, int cm, int cd, bool leapMonthFlag)
        {
        ...
        public string DateString
        {
            get
            {
                return this._date.ToString("yyyy年M月d日");
            }
        }
        #endregion
        #region IsLeapYear
        ...
        public string ChineseDateString
        {
            get
            {
                if (this._cIsLeapMonth == true)
                {
                    ...
                    return "农历" + AnimalString + "年 " + "闰" + ChineseMonthString + ChineseDayString;
                }
                else
                {
                    //return "农历" + ChineseYearString + ChineseMonthString + ChineseDayString;
                    return "农历" + AnimalString + "年 " + ChineseMonthString + ChineseDayString;
                }
            }
        }
        #endregion
        ...
        public string Constellation
        {
            ...
            {
                //按公历算 具体时间如下 
                //牧羊座 （03/21-04/20） 热情、开朗的情人 
                //金牛座 （04/21-05/21） 奔放的情人 
                //双子座 （05/22-06/21） 善变的情人 
                //巨蟹座 （06/22-07/22） 恋家的情人 
                //狮子座 （07/23-08/22） 自信的情人 
                //处女座 （08/23-09/23） 要求完美的情人 
                //天秤座 （09/24-10/23） 若即若离的情人 
                //天蝎座 （10/24-11/22） 爱恨分明的情人 
                //射手座 （11/23-12/21） 酷爱自由的情人 
                //摩羯座 （12/22-01/20） 工作狂的情人 
                //水瓶座 （01/21-02/19） 柏拉图式的情人 
                //双鱼座 （02/20-03/20） 温柔浪漫的情人
                int index = 0;
                int y, m, d;
                y = _date.Year;
                m = _date.Month;
                d = _date.Day;
                y = m * 100 + d;
                if (((y >= 321) && (y <= 420))) { index = 0; }
                else if ((y >= 421) && (y <= 521)) { index = 1; }
                else if ((y >= 522) && (y <= 621)) { index = 2; }
                else if ((y >= 622) && (y <= 722)) { index = 3; }
                else if ((y >= 723) && (y <= 822)) { index = 4; }
                else if ((y >= 823) && (y <= 923)) { index = 5; }
                else if ((y >= 924) && (y <= 1023)) { index = 6; }
                else if ((y >= 1024) && (y <= 1122)) { index = 7; }
                else if ((y >= 1123) && (y <= 1221)) { index = 8; }
                else if ((y >= 1222) || (y <= 120)) { index = 9; }
                else if ((y >= 121) && (y <= 219)) { index = 10; }
                else if ((y >= 220) && (y <= 320)) { index = 11; }
                else { index = 0; }
        ...
        public string AnimalString
        {
            get
            {
                //int offset = _date.Year - AnimalStartYear; //阳历元旦算起
                int offset = this._cYear - AnimalStartYear;　//农历正月初一算起
        ...
        /// </summary>
        /// <returns></returns>
        public ChineseDate NextDay()
        {
            DateTime nextDay = _date.AddDays(1);
            return new ChineseDate(nextDay);
        }
        #endregion
        #region PervDay
        /// <summary>
        ...
        /// </summary>
        /// <returns></returns>
        public ChineseDate PervDay()
        {
            DateTime pervDay = _date.AddDays(-1);
            return new ChineseDate(pervDay);
        }
        #endregion
        #endregion
    }
