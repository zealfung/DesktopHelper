 ...
 *  
 *  
 * 作者：[冯梓易]   时间：2014/2/12 星期三 下午 02:16:36
 * 文件名：UpdateWebsiteXML
 * 版本：V1.0.0
 * 
 * 修改者：           时间：               
 * 修改说明：
...
{
    public class UpdateWebsiteXML
    {
        [DllImport("wininet")]
        private extern static bool InternetGetConnectedState(out int connectionDescription, int reservedValue);
        private string path = Application.StartupPath + @"\XML\WebsiteList.xml";
        ...
        public bool Download()
        {
            ...
            try
            {
                ...
                string url = "http://www.andwho.com/AndwhoUpdate/DeskHelper/WebsiteList.xml";
                Uri uri = new Uri(url);
